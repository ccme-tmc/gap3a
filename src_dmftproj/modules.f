...
!<JH
        logical:: l_wholeband = .true.      ! if true, only wole bands in the energy window are considered
!JH>

        REAL(KIND=8) :: eferm
        REAL(KIND=8) :: e_bot, e_top
        REAL(KIND=8), PARAMETER :: PI=3.1415926535898d0
        REAL(KIND=8), PARAMETER :: rev=0.073498618
...
C Type structure orbital
        ...
        TYPE orbital2
          INTEGER :: orbmax
        ENDTYPE
        TYPE(orbital2), DIMENSION(:), ALLOCATABLE :: orbitcorr
...
C-------------------
       MODULE file_names
        ...
        CHARACTER(len=35) :: cRPA_file
        CHARACTER(len=35) :: outdmatov_file
        CHARACTER(len=35) :: klist_file, klist2_file
        ...
        CHARACTER(len=12),PARAMETER :: cRPA_ext='projcrpa'
        ...
        CHARACTER(len=10), PARAMETER :: klist2_ext='klist'
        ...
        CHARACTER(len=9), PARAMETER :: outdmatov_ext='outdmatov'
       CONTAINS
...
C Construct file names
        ...
        CALL set_file_name(cRPA_file,cRPA_ext)
        CALL set_file_name(klist2_file,klist2_ext)
        ...
        CALL set_file_name(outdmatov_file,outdmatov_ext)
...
C Open units      
        ...
        call getenv("WIENROOT",wien_path)
        write(6,*) "$WIENROOT= ",trim(wien_path)
C
        RETURN
        END SUBROUTINE
C
...
C output
        ...
        ouband=21        ! bands
        oudmatov=899     ! overlap matrix before and after orthonormalization of Wannier
