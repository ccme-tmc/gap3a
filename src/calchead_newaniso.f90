!BOP
!
! !ROUTINE: calchead_newaniso
!
! !INTERFACE:
      subroutine calchead_newaniso(ikfirst,iklast,iomfirst,iomlast)
...
! !LOCAL VARIABLES:
      logical:: ldbg=.true.
      !logical:: ldbg=.false.
      character(10):: sname="calchead_newaniso"
...
! new 
     ...
     &            eta_head/(om*(om**2+eta_head**2)),8)
      ...
      end subroutine calchead_newaniso
!EOC      
