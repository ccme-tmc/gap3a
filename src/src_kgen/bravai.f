...
!:UB  ..................................................................
      ...
      DATA LATTIC /'GT','GM','GMB','GO','GOB','GOV','GOF','GQ','GQV',   &
     &'GRH' ,'GH','GC','GCF','GCV'/
...
!cc      IF(LATTI(1:1).EQ.'F'.AND.AX.EQ.BX) GOTO 190
...
!cc      IF(LATTI(1:1).EQ.'B'.AND.AX.EQ.BX.AND.AX.EQ.CX) GOTO 200
!cc      IF(LATTI(1:1).EQ.'B'.AND.AX.EQ.BX) GOTO 150
      IF(LATTI(1:1).EQ.'B') GOTO 120
      if(latti(1:1).eq.'P'.and.abs(gamma-1.570796d0).gt.0.0001) goto 70
      if(latti(1:1).eq.'P'.and.abs(beta -1.570796d0).gt.0.0001) goto 70
      if(latti(1:1).eq.'P'.and.abs(alpha-1.570796d0).gt.0.0001) goto 70
!
      if(latti(1:1).eq.'C'.and.abs(gamma-1.570796d0).gt.0.0001) goto 90
!cc      IF(LATTI(1:1).EQ.'S'.AND.AX.EQ.BX.AND.AX.EQ.CX) GOTO 180
!cc      IF(LATTI(1:1).EQ.'P'.AND.AX.EQ.BX.AND.AX.EQ.CX) GOTO 180
!cc      IF(LATTI(1:1).EQ.'S'.AND.AX.EQ.BX) GOTO 140
!cc      IF(LATTI(1:1).EQ.'P'.AND.AX.EQ.BX) GOTO 140
...
!     AY = A * COS(GAMMA) / 2
!     CX = C / 2
!:UB[ ay=ax(orig)*cos(gamma)/2 thus ay must be evaluated first
...
!     ORTHOROMBIC : GOF
  130 AX=AX*0.5E0
      ...
      CX=CX*0.5E0
!:UB[ << ai = RBAS(i,*) >>
!:UB  << ai consistent with dirlat.f and latgen.f ! >>
!      RBAS(1,1)=AX
!      RBAS(3,1)=CX
!      RBAS(2,2)=-BX
!      RBAS(3,2)=CX
...
!      V=(2*PI)**3/DET
!      WRITE (66,270)
  270 FORMAT (1H ,'  RECIPROCAL LATTICE VECTORS IN UNITS CONSISTENT WITH R')
!      DO 280 J=1,3
!:UB[  << bi = GBAS(*,i) >>
!  280 WRITE (66,290) J,(GBAS(I,J),I=1,3)
!:UB]
