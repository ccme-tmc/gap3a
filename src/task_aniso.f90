...
!
! !INTERFACE:
      subroutine task_aniso
      
! !DESCRIPTION:
!
! This task subroutine tests the anisotropy functionality
! !USES:
...
! !LOCAL VARIABLES:
      ...
      character(len=20):: sname = "task_aniso"
      character(len=20):: blk_gw = "aniso"
