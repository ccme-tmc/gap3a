...
!of equation \ref{Mdef} for n => core and m => core vector
!
! !USES:
...
! !LOCAL VARIABLES:
      ...
      real(8) :: time1,time2
      logical :: lprt = .false.
      character(8), parameter :: sname = 'calcmicc'
...
!BOC
      ...
      allocate(mcc(locmatsiz,ccdim), stat=ierr)
      call errmsg(ierr.ne.0, sname, 'Fail to allocate mcc')
