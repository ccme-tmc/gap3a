!BOP
!
! !ROUTINE: exc_readstruct
!
! !INTERFACE: 
      subroutine exc_readstruct
!
! !DESCRIPTION:
!
! {\bf WIEN2k interface:}
...
! !DEFINED PARAMETERS:
      ...
      character(len=12), parameter :: sname = 'exc_readstruct' ! name of the  subroutine, to include it in error messages.
!EOP
!BOC
