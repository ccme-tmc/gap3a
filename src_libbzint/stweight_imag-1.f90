...
!                                  and k-q mesh tetrahedron vertices.
      ...
      integer(4), intent(in) :: equiv_flag ! If equiv_flag=4, it belongs to the none
!                                    equally case. If equiv_flag=6, deltae_vert(1)=deltae_vert(2).
!                                    If equiv_flag=8, deltae_vert(1)=deltae_vert(2) and deltae_vert(3)=deltae_vert(4).
!                                    If equiv_flag=10, deltae_vert(1)=deltae_vert(2)=deltae_vert(3).
!                                    If equiv_flag=16, deltae_vert(1)=deltae_vert(2)=deltae_vert(3)=deltae_vert(4). 
...
!          dd=6.0d0*omeg*(omeg**2 + ev(3)*ev(3) - 2.0d0*ev(1)*ev(3)) 
...
!          dd=6.0d0*omeg*(omeg**2 + ev(1)**2 - 2.0d0*ev(1)*ev(3))
     ...
     &       11.0d0*ev(4)**2)     
      ...
      contains
        ...
        if(abs(weight_vert(ivert)).gt.weightwarn) then 
          write(fout,1)ivert,weight_vert(ivert),equiv_flag,omeg, &
     &                  deltae_vert,vdif,aa,bb,cc,vol_small_tetra
        endif
    1   format('WARNING in stweight_imag: vertix:',i4,&
